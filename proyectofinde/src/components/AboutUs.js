...
const AboutUs = () => {
  return (
    <div id="about" class="container-fullwidth">    
          <div class="row">
            <div class="col-sm-8">
              ...
              <br></br><button class="btn btn-info btn-lg">Get in Touch</button>
            </div>
            <div class="col-sm-4">
              <span class="glyphicon glyphicon-signal logo pull-center"></span>
            </div>
          </div>
